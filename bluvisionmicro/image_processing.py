...
class ImageProcessing:
    ...
    def min_ip_stacking(self, image_array, region, z_level, czi_format):
        ...
        self.image_stacked = cv2.cvtColor(image_stacked, cv2.COLOR_BGR2RGB)
